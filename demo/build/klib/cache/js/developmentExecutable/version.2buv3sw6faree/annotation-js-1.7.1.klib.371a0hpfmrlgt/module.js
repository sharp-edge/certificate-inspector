(function (factory) {
  ...
  initMetadataForClass(ColorInt, 'ColorInt', VOID, VOID, [Annotation]);
  initMetadataForClass(FloatRange, 'FloatRange', VOID, VOID, [Annotation]);
  ...
  initMetadataForClass(Size, 'Size', VOID, VOID, [Annotation]);
